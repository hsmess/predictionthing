            ...
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="px-4 py-4 sm:px-0">
                    <div class="border-4 border-dashed border-gray-200 rounded-lg h-85 p-3">
                        <h1 class="text-3xl tracking-tight font-bold text-gray-900 sm:text-4xl md:text-4xl"> <span class="block text-indigo-600 xl:inline">What will the total number of shots thrown across the whole group?</span></h1>

                        <div class="bg-white shadow sm:rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Enter total score (E.G 1400)</h3>
                                <div class="mt-2 max-w-xl text-sm text-gray-500">
                                    <p>Remember, Jamie might or might not be playing - makes guessing hard huh?</p>
                                </div>
                                <form class="mt-5 sm:flex sm:items-center" action="/vote-q4" method="get">
                                    <div class="w-full sm:max-w-xs">
                                        <input type="number" name="total_score" id="total_score" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="1400">
                                    </div>
