            ...
            <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div class="px-4 py-4 sm:px-0">
                    <div class="border-4 border-dashed border-gray-200 rounded-lg h-85 p-3">
                        <h1 class="text-3xl tracking-tight font-bold text-gray-900 sm:text-4xl md:text-4xl"> <span class="block text-indigo-600 xl:inline">What will be the winning score?</span></h1>

                        <div class="bg-white shadow sm:rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Enter total score (E.G 330)</h3>
                                <div class="mt-2 max-w-xl text-sm text-gray-500">
                                    <p>Par for our 100 holes will be 314</p>
                                </div>
                                <form class="mt-5 sm:flex sm:items-center" action="/vote-q3" method="get">
                                    <div class="w-full sm:max-w-xs">
                                        <input type="number" name="total_score" id="total_score" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="314">
                                    </div>
